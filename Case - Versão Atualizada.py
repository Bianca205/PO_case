...
profissionais = {
    "PS1": {"tipo": "psicologo", "disponibilidade": 7},
    "PS2": {"tipo": "psicologo", "disponibilidade": 7},
    "PS3": {"tipo": "psicologo", "disponibilidade": 7},
    "PS4": {"tipo": "psicologo", "disponibilidade": 7},
    "PS5": {"tipo": "psicologo", "disponibilidade": 7},
    "PQ1": {"tipo": "psiquiatra", "disponibilidade": 5},
    "PQ2": {"tipo": "psiquiatra", "disponibilidade": 5},
    "PQ3": {"tipo": "psiquiatra", "disponibilidade": 5},
    "PA1": {"tipo": "psicanalista", "disponibilidade": 4},
    "PA2": {"tipo": "psicanalista", "disponibilidade": 4},
}
...
# -------------------------------
escala_manual = {
    "PS1": ['T1', 'T2', 'T4', 'T6', 'T8', 'T10', 'T12'],
    "PS2": ['T1', 'T3', 'T5', 'T6', 'T9', 'T11', 'T12'],
    "PS3": ['T2', 'T3', 'T4', 'T7', 'T9', 'T10', 'T11'],
    "PS4": ['T1', 'T3', 'T5', 'T7', 'T8', 'T10', 'T11'],
    "PS5": ['T2', 'T4', 'T5', 'T6', 'T8', 'T9', 'T12'],
    "PQ1": ['T2', 'T5', 'T8', 'T10', 'T12'],
    "PQ2": ['T1', 'T3', 'T6', 'T9', 'T11'],
    "PQ3": ['T4', 'T5', 'T7', 'T8', 'T10'],
    "PA1": ['T3', 'T6', 'T9', 'T12'],
    "PA2": ['T2', 'T4', 'T7', 'T11']
